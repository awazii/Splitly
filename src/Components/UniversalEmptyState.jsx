        ...
        <div className="flex flex-col items-center justify-center h-full p-12 pt-6  text-center space-y-4">
            ...
            <div> 
                <div className={`${children}`}>
                  ...
                  {button?.type && (
                    <button onClick={() => Navigate(button.Link)} className="mt-2 px-4 py-2 rounded-lg bg-primary text-white hover:bg-primary-dark transition-colors cursor-pointer">Go Back to {button.type}</button>
                  )}
                </div>
            </div>
